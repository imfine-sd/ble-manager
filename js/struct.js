...
(function (global, undefined) {
    ...
    Struct.prototype = {
      ...
      read: function (arrayBuffer, offset) {
        ...
        if (
          ...
          arrayBuffer.byteLength < this.byteLength
        )
        ...
        var readed = align(this.struct, function (item, prop, struct) {
          ...
          if (vary === true) {
            length =
              dv["get" + capitalise(lengthTyped)](that.offset, endian) / size;
      ...
      write: function (struct) {
        ...
        align(this.struct, function (item, prop) {
          ...
          if (vary === true) {
            dataView["set" + capitalise(lengthTyped)](
              offset,
              length * size,
              endian
            );
    ...
    function arrayBufferToArray(buf, typed) {
      return Array.prototype.slice.call(
        new global[capitalise(typed) + "Array"](buf)
      );
    }
